...
To test this separability hypothesis discussed in Section \ref{sec:factorization_test}, we constructed candidate models that multiply an independent longitudinal profile by various transverse $b^2$ profiles, including combinations of Gaussian, Lorentzian power-law, and exponential-decay forms. We evaluated each model with full Jackknife fits.
...
With this structural form established, the following sections determine its detailed $\eta$-dependence for each amplitude and finalize the candidate models before the global simultaneous fit.
