...
\newpage
\input{Chapters/LATTICE_QCD_METHODOLOGY}
\newpage
\input{Chapters/THEORETICAL_FRAMEWORK_OF_TMDs}
\newpage
\input{Chapters/EXTRACTING_THE_x-DEPENDENCE}
\newpage
\input{Chapters/FITTING_METHODOLOGIES_AND_STABILITY_ANALYSIS}
\newpage
\input{Chapters/EXTRAPOLATIONS-TO-THE-PHYSICAL-LIMIT}
\newpage
~
\newpage
~
